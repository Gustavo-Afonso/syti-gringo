            ...
            <Card className="relative overflow-hidden transition-transform transform hover:scale-105 hover:shadow-lg">
              <CardContent className="p-6">
                <div className="flex flex-col items-center space-y-4 text-center">
                  <div className="rounded-full bg-gradient-to-r from-red-950 to-black p-4">
                    <DollarSign className="h-8 w-8 text-green-500" />
                  </div>
                  <h3 className="text-xl font-bold bg-gradient-to-r from-red-500 to-red-950 bg-clip-text text-transparent">
                    Cost Effective
                  </h3>
